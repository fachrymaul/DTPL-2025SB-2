...
export default function KonserKecapiSuling({
    ticket,
}: {
    ticket: TicketData | null;
}) {
    const { t } = useLanguage();
    const data = t.konserKecapiSuling;
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <ul className="mt-4 space-y-3">
                                {data.highlights.map((item) => (
                                    ...
                                    >
                                        <Music className="mt-0.5 h-5 w-5 shrink-0 text-amber-500" />
                            ...
                            <h3 className="mt-10 text-xl font-semibold">
                                {data.repertoireTitle}
                            </h3>
                            <div className="mt-4 grid gap-4 sm:grid-cols-2">
                                {data.repertoire.map((item) => (
                                    <div
                                        key={item}
                        ...
                        <div>
                            <div className="rounded-xl border border-border bg-card p-6">
                                ...
                                <dl className="mt-4 space-y-4">
                                    ...
                                    <div className="flex items-start gap-3">
                                        <HandCoins className="mt-0.5 h-5 w-5 text-amber-500" />
                                        <div>
                                            <dt className="text-sm font-medium">
                                                {data.ticketPrice}
                                            </dt>
