    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-background text-foreground">
                ...
                {/* Hero */}
                <section className="relative bg-gradient-to-br from-sky-500/20 via-sky-500/10 to-background py-20">
                    <div className="mx-auto max-w-4xl px-6 text-center">
                        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-sky-500/20">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <ul className="mt-4 space-y-3">
                                {data.highlights.map((item) => (
                                    ...
                                    >
                                        <Waves className="mt-0.5 h-5 w-5 shrink-0 text-sky-500" />
                            ...
                            <div className="rounded-xl border border-border bg-card p-6">
                                ...
                                <dl className="mt-4 space-y-4">
                                    <div className="flex items-start gap-3">
                                        <Waves className="mt-0.5 h-5 w-5 text-sky-500" />
                                        <div>
                                            <dt className="text-sm font-medium">
                                                {data.riverGrade}
                                            </dt>
                                            <dd className="text-sm text-muted-foreground">
                                                {data.riverGradeValue}
                                            </dd>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex items-start gap-3">
                                        <AlertTriangle className="mt-0.5 h-5 w-5 text-sky-500" />
                                        <div>
                                            <dt className="text-sm font-medium">
                                                {data.ageReq}
                                            </dt>
                                    ...
                                    <div className="flex items-start gap-3">
                                        <HandCoins className="mt-0.5 h-5 w-5 text-sky-500" />
                                        <div>
                                            <dt className="text-sm font-medium">
                                                {data.ticketPrice}
                                            </dt>
